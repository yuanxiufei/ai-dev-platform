...
<template>
  <footer class="h-[var(--statusbar-height)] bg-[var(--color-statusbar-bg)] border-t border-[var(--color-ide-border)] flex items-center px-1.5 shrink-0 select-none text-xs">
    <div class="flex items-center divide-x divide-[#33334a]">
      <button class="flex items-center gap-1 px-2 py-1 hover:bg-white/5 rounded"><GitBranch :size="14" class="text-[var(--color-statusbar-text)]" /><span class="text-[var(--color-statusbar-text)]">main</span></button>
      <button class="flex items-center gap-1 px-2 py-1 hover:bg-white/5 rounded"><XCircle :size="14" class="text-green-400" /><span class="text-[var(--color-statusbar-text)]">0</span><AlertCircle :size="14" class="text-yellow-400 ml-1" /><span class="text-[var(--color-statusbar-text)]">0</span></button>
